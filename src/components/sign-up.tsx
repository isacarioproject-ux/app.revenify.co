...
export default function SignUpPage() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setEmailSent(true)
            toast.success('Sign up link sent!', {
            ...
            <div className="w-full max-w-md">
                    <form onSubmit={handleSignUp}>
                        <div className="text-center mb-6">
                            ...
                            <h1 className="mb-1 mt-4 text-2xl font-semibold">Create your account</h1>
                            <p className="text-muted-foreground">Welcome! Sign up to get started</p>
                        </div>
