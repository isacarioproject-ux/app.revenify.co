...
export function RainbowButton({
  ...
  const baseClassName = cn(
    ...
    // dark mode - fundo escuro para texto branco ser visível
    "dark:bg-[linear-gradient(#1a1a1a,#1a1a1a),linear-gradient(#1a1a1a_50%,rgba(26,26,26,0.6)_80%,rgba(0,0,0,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
